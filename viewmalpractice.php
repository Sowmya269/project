...
$sql = "insert into  malpractice ( staffname,staffid,studentname,studentid,Malpractice,malpracticedate) values('$staffname','$staffid','$studentname','$studentid','$Malpractice','$malpracticedate')";
 echo $sql;
        $conn->exec($sql);
...
<html lang="en">
  ...
  <body>
   ...
   <section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url(images/p6.jpg);" data-stellar-background-ratio="0.5">
    	<div class="container">
    		
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	            <h2 align="center">View Malpractice Details</h2>
	...
	<?php
		...
		$result = $conn->prepare("SELECT staffname,staffid,studentname,studentid,SubjectName,Malpractice, malpracticedate FROM malpractice ORDER BY id ASC");
		$result->execute();
